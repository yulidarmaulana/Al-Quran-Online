    ...
    return `<div class="col-md-6">
              <div class="card p-3 my-2">
                <div class="card-body">
                  ...
                  <button class="btn btn-outline-success baca" data-bs-toggle="modal" data-bs-target="#modal" data-id="${nomor}">Baca Surat Ini</button>
                </div>
              </div>
            </div>`;
  }
  ...
  function showModalContent(data) {
    return `<div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="bg-success bg-gradient p-4 rounded shadow-sm">
                    <div class="d-flex justify-content-between">
                      <div class="d-flex flex-column">
